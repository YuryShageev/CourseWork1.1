...
Employee[] employees = new Employee[10];
    ...
    public static void printAverageSalary(Employee[] employees) {
        ...
        averageSalary = totalSalary / employeesAmount; //Будет пропускать нулевых (отсутствующих сотрудников)
//        averageSalary = totalSalary / employees.length; // Если оставить с length, он будет учитывать сотрудников, которых нет
